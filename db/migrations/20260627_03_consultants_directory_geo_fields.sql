...
grant execute on function public.get_consultants_directory_page(text, text, text, text, integer, integer, text, text) to anon, authenticated, service_role;
