...
create index if not exists idx_consultants_visibility on public.consultants (visibility);
create index if not exists idx_consultants_display_name_trgm
  on public.consultants using gin (display_name gin_trgm_ops);
...
begin
  if exists (
    ...
    execute 'create index if not exists idx_consultants_visibility_status on public.consultants (visibility, status)';
    execute 'create index if not exists idx_consultants_public_approved_id
      on public.consultants (id)
      where visibility = ''public'' and status = ''approved''';
  else
    execute 'create index if not exists idx_consultants_public_id
      on public.consultants (id)
  ...
  if exists (
    ...
    execute 'create index if not exists idx_consultants_provider_kind on public.consultants (provider_kind)';
  end if;
end
$$;
