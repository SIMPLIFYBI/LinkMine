    ...
    <tr><td style="padding:24px;">
      ...
      <p style="margin:0 0 18px;" align="left">
        ...
        <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${enterCodeUrl}" style="height:44px;v-text-anchor:middle;width:200px;" arcsize="50%" stroke="f" fillcolor="#0ea5e9">
          <w:anchorlock/>
          <center style="color:#ffffff;font-family:Segoe UI, Arial, sans-serif;font-size:14px;font-weight:700;line-height:20px;">Enter code</center>
        </v:roundrect>
        <![endif]-->
        <!--[if !mso]><!-- -->
        <a href="${enterCodeUrl}"
           style="display:inline-block;background-color:#0ea5e9;background-image:linear-gradient(90deg,#0ea5e9,#6366f1);color:#ffffff;text-decoration:none;font-weight:800;font-size:14px;line-height:20px;padding:12px 18px;border-radius:999px;border:1px solid rgba(255,255,255,.18);mso-line-height-rule:exactly;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;white-space:nowrap;vertical-align:middle;">
          Enter code
        </a>
        <!--<![endif]-->
      </p>
