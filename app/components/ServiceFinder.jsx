          ...
          >
            ...
            <div className="border-b border-white/10 p-2">
              ...
              <input
                ...
                className="w-full rounded-xl border border-white/10 bg-white/10 px-3 py-2 text-base text-slate-100 placeholder:text-slate-300 focus:border-sky-400/60 focus:outline-none focus:ring-2 focus:ring-sky-400/30"
              />
            </div>
