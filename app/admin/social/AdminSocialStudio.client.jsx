...
const BRANDING_ASSETS = [
  ...
  {
    id: "elevated-gradient",
    family: "Elevated wordmark",
    label: "Elevated gradient",
    description: "A sharper merch-ready take on the core YouMine. wordmark with a stronger dot and accent rail.",
    previewSrc: "/brand/youmine-wordmark-elevated-gradient.svg",
    svgHref: "/brand/youmine-wordmark-elevated-gradient.svg",
    pngHref: "/brand/exports/youmine-wordmark-elevated-gradient-4200w.png",
    surfaceClass: "bg-[linear-gradient(135deg,#eff6ff,#dbeafe_45%,#eef2ff)]",
  },
  {
    id: "elevated-black",
    family: "Elevated wordmark",
    label: "Elevated black",
    description: "One-colour version of the punched-up wordmark for light merch and print suppliers.",
    previewSrc: "/brand/youmine-wordmark-elevated-black.svg",
    svgHref: "/brand/youmine-wordmark-elevated-black.svg",
    pngHref: "/brand/exports/youmine-wordmark-elevated-black-4200w.png",
    surfaceClass: "bg-white",
  },
  {
    id: "elevated-white",
    ...
    description: "Reverse version for dark garments, signage, and mockups that need more presence than the base wordmark.",
    previewSrc: "/brand/youmine-wordmark-elevated-white.svg",
    svgHref: "/brand/youmine-wordmark-elevated-white.svg",
    pngHref: "/brand/exports/youmine-wordmark-elevated-white-4200w.png",
    surfaceClass: "bg-[linear-gradient(145deg,#020617,#0f172a_52%,#111827)]",
  },
  {
    id: "stacked-gradient",
